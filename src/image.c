...
void
wob_image_draw(uint32_t *image_data, struct wob_dimensions dimensions, struct wob_colors colors, double percentage, unsigned long value, struct wob_font *font)
{
	...
	if (font != NULL) {
		...
		snprintf(percentage_buff, 64, "%lu", value);
